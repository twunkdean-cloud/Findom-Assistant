  ...
  const handleGenerateDescription = async (persona: 'dominant' | 'submissive' | 'switch') => {
    ...
    switch (persona) {
      case 'dominant':
        ...
        break;
      case 'submissive':
        specificImageInstruction = `Analyze the uploaded image and generate a detailed AI image editing prompt that will transform the photo to radiate submissive, devoted energy. Focus on visual elements that convey humility, reverence, and obedience. Include specific instructions for lighting (softer, more gentle), pose adjustments (kneeling, bowed head, respectful posture), facial expressions (adoring, humble, worshipful), clothing elements (simpler fabrics, respectful attire), and environmental details that emphasize submission. The prompt should guide an AI to create an image where the subject appears devoted, respectful, and willingly submissive.`;
        break;
      case 'switch':
        specificImageInstruction = `Analyze the uploaded image and generate a detailed AI image editing prompt that will transform the photo to radiate versatile switch energy, blending both dominant and submissive qualities. Focus on visual elements that convey duality, adaptability, and magnetic presence. Include specific instructions for lighting (dynamic, shifting shadows), pose adjustments (confident yet approachable stance), facial expressions (intriguing, multifaceted gaze), clothing elements (mix of authoritative and subtle elements), and environmental details that highlight the switch's versatility. The prompt should guide an AI to create an image where the subject appears both powerful and approachable, embodying the allure of both roles.`;
        break;
    }
